...
class EditDocteur extends StatefulWidget {
  const EditDocteur({super.key});

  @override
  State<EditDocteur> createState() => _EditDocteurState();
}

class _EditDocteurState extends State<EditDocteur> {
